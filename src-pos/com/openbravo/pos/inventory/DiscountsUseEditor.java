 ...
 */
public class DiscountsUseEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    private Object insertdisc;

    /** Creates new form DiscountUseEditor */
    public DiscountsUseEditor(AppView app, DirtyManager dirty) {
    ...
    public void setInsertDiscount(DiscountInfo disc) {
        
        if (disc == null) {
            insertdisc = null;
        } else {
            insertdisc = disc.getId();
        }
    }
