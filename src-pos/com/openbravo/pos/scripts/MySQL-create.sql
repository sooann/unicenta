...
CREATE TABLE DISCOUNT_PROD (
    ID VARCHAR(256) NOT NULL,
    DISCOUNT VARCHAR(256) NOT NULL,
    PRODUCT VARCHAR(256) NOT NULL,
    PRIMARY KEY (ID),
    CONSTRAINT DISCOUNT_PROD_FK_1 FOREIGN KEY (PRODUCT) REFERENCES PRODUCTS(ID)
    CONSTRAINT DISCOUNT_PROD_FK_2 FOREIGN KEY (DISCOUNT) REFERENCES DISCOUNTS(ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;